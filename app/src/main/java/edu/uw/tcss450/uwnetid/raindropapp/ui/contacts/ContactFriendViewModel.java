...
public class ContactFriendViewModel extends AndroidViewModel {
    private final MutableLiveData<JSONObject> mResponse;

    public ContactFriendViewModel(@NonNull Application application) {
        super(application);
    ...
    public void addFriend(final String jwt, final int verified) {
